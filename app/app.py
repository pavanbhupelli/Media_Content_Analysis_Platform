...
# # -------------------------------------------------------
# # CLEAN CSS (No divider bars, compact layout)
# # -------------------------------------------------------
# st.markdown("""
# <style>
# .block-container {
...
# top_n = st.sidebar.slider("Top N Records", 3, 10, 5)
...
# # Helper function to disable animation
# def static_layout(fig, height=230):
#     fig.update_layout(
...
#     fig3 = px.bar(top_videos, x="view_count", y="channel_title",
#                   orientation="h",
#                   color_discrete_sequence=["#F59E0B"])
#     fig3.update_layout(plot_bgcolor="#1F2937", paper_bgcolor="#1F2937")
#     static_layout(fig3)
...
#     fig4.update_layout(height=260, plot_bgcolor="#0B3B5A",
#                        paper_bgcolor="#0B3B5A", font_color="white",
#                        transition_duration=0)
...
#     fig5.update_layout(height=260, plot_bgcolor="#064E3B",
#                        paper_bgcolor="#064E3B", font_color="white",
#                        transition_duration=0)
...
#     st.subheader("Engagement Trend (Year Filter Applied)")
